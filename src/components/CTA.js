      ...
      <section className="c-t-a">
        <div className="section5">
          ...
          <div className="eee9d27c1241a14134c1f4-primary8">
            <div className="my-name-is-aravind-your-desig-parent3">
              ...
              <div className="link18">
                <div className="ask-questions9">Ask Questions</div>
                <img className="svg-icon14" alt="" src="/svg-2@2x.png" />
              </div>
              <img
          ...
          <div className="eee9d27c1241a14134c1f4-primary9">
            <img className="image-icon15" alt="" src="/image-6@2x.png" />
                ...
                <div className="ask-button-container">
                  <button className="link19">
                    ...
                    <div className="ask-button-icon-container">
                      <img className="svg-icon15" alt="" src="/svg-3@2x.png" />
                    </div>
                  </button>
                </div>
              </div>
            </div>
            <img className="image-icon16" alt="" src="/image-7@2x.png" />
          </div>
        </div>
